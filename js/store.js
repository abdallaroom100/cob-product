!function() {
    var t = function(t) {
      ...
      , x = t((function(t) {
        ...
        (t.exports = function(t, r, n, a) {
            ...
            t[r] !== n && (s && (m(n, e) || y(n, e, t[r] ? "" + t[r] : o.join(String(r)))),
            t === i ? t[r] = n : a ? t[r] ? t[r] = n : y(t, r, n) : (delete t[r],
            y(t, r, n)))
        }
      ...
      , _ = (t((function() {
        ...
        var t = {};
        t[s("toStringTag")] = "z",
        t + "" != "[object z]" && x(Object.prototype, "toString", (function() {
    ...
    t((function(t) {
      ...
      , S = t((function(t) {
        t.exports = function(t) {
            return function(e, r) {
                var n, i, o = String(k(e)), a = _(r), s = o.length;
      ...
      , O = t((function(t) {
        var e = "prototype"
          , r = function(t, n, o) {
            var a, s, u, c, f = t & r.F, l = t & r.G, h = t & r.S, p = t & r.P, d = t & r.B, b = l ? i : h ? i[n] || (i[n] = {}) : (i[n] || {})[e], w = l ? g : g[n] || (g[n] = {}), v = w[e] || (w[e] = {});
            for (a in l && (o = n),
            o)
                u = ((s = !f && b && void 0 !== b[a]) ? b : o)[a],
                c = d && s ? E(u, i) : p && "function" == typeof u ? E(Function.call, u) : u,
                b && x(b, a, u, t & r.U),
                w[a] != u && y(w, a, c),
                p && v[a] != u && (v[a] = u)
        };
      ...
      , R = t((function(t) {
        t.exports = function(t) {
            return function(e, r, n) {
                var i, o = L(e), a = B(o.length), s = M(n, a);
                if (t && r != r) {
                    for (; a > s; )
                        if ((i = o[s++]) != i)
                            return !0
      ...
      , q = t((function(t) {
        var e = N("IE_PROTO")
          ...
          , n = "prototype"
          , i = function() {
            var t, e = p("iframe"), r = C.length, o = "<", a = ">";
      ...
      , H = t((function(t) {
        ...
        t.exports = Object.getPrototypeOf || function(t) {
            return t = V(t),
            m(t, e) ? t[e] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? r : null
        }
    }
    ))
      , W = t((function(t) {
        ...
        t.exports = function(t, s, u, c, f, l, h) {
            ...
            }, v = s + " Iterator", g = f == o, _ = !1, k = t.prototype, S = k[e] || k[n] || f && k[f], A = S || w(f), E = f ? g ? w("entries") : A : void 0, P = "Array" == s && k.entries || S;
            if (P && (b = H(P.call(new t))) !== Object.prototype && b.next && (z(b, v, !0),
            T || m(b, e) || y(b, e, a)),
            g && S && S.name !== o && (_ = !0,
            A = function() {
                return S.call(this)
    ...
    t((function(t) {
      ...
      , Z = t((function(t) {
        ...
        t.exports = W(Array, "Array", (function(t, e) {
            ...
            X(1)) : X(0, "keys" == e ? r : "values" == e ? t[r] : [r, t[r]])
        }
        ), "values"),
        j.Arguments = j.Array,
        K("keys"),
      ...
      , $ = (t((function() {
        for (var t = s("iterator"), e = s("toStringTag"), r = j.Array, n = {
            ...
            var u, c = o[a], f = n[c], l = i[c], h = l && l.prototype;
            if (h && (h[t] || y(h, t, r),
            h[e] || y(h, e, c),
            j[c] = r,
            f))
    ...
    t((function(t) {
      ...
      , tt = t((function(t, e) {
        ...
        (e = t.exports = function(t, e, i, o, a) {
            ...
            : Q(t), p = E(i, o, e ? 2 : 1), d = 0;
            if ("function" != typeof h)
                throw TypeError(t + " is not iterable!");
            if (J(h)) {
                for (s = B(t.length); s > d; d++)
                    if ((l = e ? p(f(u = t[d])[0], u[1]) : p(t[d])) === r || l === n)
                        return l
            } else
                for (c = h.call(t); !(u = c.next()).done; )
                    if ((l = Y(c, p, u.value, e)) === r || l === n)
                        return l
        }
        ).BREAK = r,
        e.RETURN = n
      ...
      , nt = t((function(t) {
        var e, r, o, a = i.process, s = i.setImmediate, u = i.clearImmediate, c = i.MessageChannel, f = i.Dispatch, l = 0, h = {}, d = "onreadystatechange", b = function() {
            var t = +this;
        ...
        : c ? (o = (r = new c).port2,
        r.port1.onmessage = w,
        e = E(o.postMessage, o, 1)) : i.addEventListener && "function" == typeof postMessage && !i.importScripts ? (e = function(t) {
            i.postMessage(t + "", "*")
        }
        ,
    ...
    t((function() {
        "use strict";
        var t, e, r, n, o = nt.set, a = it(), f = "Promise", l = i.TypeError, h = i.process, p = i[f], d = "process" == u(h), b = function() {}, w = e = ot.f, v = !!function() {
            try {
                var t = p.resolve(1)
            ...
            if (!t._n) {
                ...
                a((function() {
                    for (var n = t._v, i = 1 == t._s, o = 0, a = function(e) {
                        var r, o, a = i ? e.ok : e.fail, s = e.resolve, u = e.reject, c = e.domain;
                        try {
                            a ? (i || (2 == t._h && k(t),
                            t._h = 1),
                            !0 === a ? r = n : (c && c.enter(),
                            r = a(n),
                            c && c.exit()),
                            r === e.promise ? u(l("Promise-chain cycle")) : (o = y(r)) ? o.call(r, s, u) : s(r)) : u(n)
                        } catch (t) {
                            u(t)
                        }
                    }; r.length > o; )
            ...
            this._initBody = function(t) {
                ...
                t)
                    if ("string" == typeof t)
                        ...
                        if (!v.arrayBuffer || !ArrayBuffer.prototype.isPrototypeOf(t) && !g(t))
    ...
    function(t) {
        ...
        var b, w = Object.prototype, v = w.hasOwnProperty, y = "function" == typeof Symbol ? Symbol : {}, m = y.iterator || "@@iterator", g = y.asyncIterator || "@@asyncIterator", x = y.toStringTag || "@@toStringTag", _ = "object" == typeof module, k = t.regeneratorRuntime;
        if (k)
            _ && (module.exports = k);
        else {
            ...
            h.prototype = {
                ...
                reset: function(t) {
                    ...
                    !t)
                        for (var e in this)
                            "t" === e.charAt(0) && v.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = b)
                },
                stop: function() {
                    this.done = !0;
    ...
    var lt = t((function(t, e) {
        !function(r, n) {
            ...
            var i = "0.7.37"
                    ...
                    for (r = i = 0; r < h.length && !u && h[r]; )
                        if (u = h[r++].exec(t))
                            for (o = 0; o < p.length; o++)
                                f = u[++i],
                                typeof (a = p[o]) === c && a.length > 0 ? 2 === a.length ? typeof a[1] == s ? this[a[0]] = a[1].call(this, f) : this[a[0]] = a[1] : 3 === a.length ? typeof a[1] !== s || a[1].exec && a[1].test ? this[a[0]] = f ? f.replace(a[1], a[2]) : n : this[a[0]] = f ? a[1].call(this, f, a[2]) : n : 4 === a.length && (this[a[0]] = f ? a[3].call(this, f.replace(a[1], a[2])) : n) : this[a] = f || n;
                    l += 2
                }
            }
              , Q = function(t, e) {
              ...
              , rt = function(t, e) {
                ...
                return this.getBrowser = function() {
                    ...
                    t[l] = $(t[w]),
                    _ && i && i.brave && typeof i.brave.isBrave == s && (t[p] = "Brave"),
                    t
                }
                ,
                ...
                this.getDevice = function() {
                    ...
                    _ && "Macintosh" == t[h] && i && typeof i.standalone !== u && i.maxTouchPoints && i.maxTouchPoints > 2 && (t[h] = "iPad",
                    t[d] = g),
                    t
                }
                ,
                ...
                this.getOS = function() {
                    ...
                    t[w] = n,
                    J.call(t, a, x.os),
                    _ && !t[p] && y && "Unknown" != y.platform && (t[p] = y.platform.replace(/chrome os/i, V).replace(/macos/i, H)),
                    t
                }
                ,
                ...
                this.setUA = function(t) {
                    return a = typeof t === f && t.length > S ? Y(t, S) : t,
                    this
                }
                ,
                this.setUA(a),
            ...
            "object" !== u ? ("object" !== u && t.exports && (e = t.exports = rt),
            e.UAParser = rt) : typeof define === s && define.amd ? define((function() {
                return rt
            }
        ...
        function() {
            ...
            return regeneratorRuntime.wrap((function(t) {
                for (; ; )
                    ...
                    case 0:
                        return t.prev = 0,
                        e = "https://" + window.ShopifyPay.apiHost + "/session?v=1",
                        r = i(),
                        n = o(),
                        null !== r && null !== n && (e += "&token=" + r + "&shop_id=" + n),
                        t.next = 7,
                        fetch(e, {
                            credentials: "include"
                        });
